"""--------------------------------------------------------------------
 * $Id: aerosol_options.py 3457 2019-03-10 12:28:56Z Claudia.Emde $
 * 
...
class setup_aerosol_group():
    ...
    #
        ...
        aerosol_king_byrne = option_definition.option(
            ...
            tokens=[option_definition.addToken(name='Input.aer.alpha_0', datatype=float, default='NOT_DEFINED_FLOAT',valid_range=[-1e6, 1e6]), 
                    option_definition.addToken(name='Input.aer.alpha_1', datatype=float, default='NOT_DEFINED_FLOAT', valid_range=[-1e6, 1e6]),
                    option_definition.addToken(name='Input.aer.alpha_2', datatype=float, default='NOT_DEFINED_FLOAT', valid_range=[-800, 800]),
                    option_definition.addSetting(name='Input.aer.spec', setting=1)],
            parents=['aerosol_default'],
        )
        ...
        aerosol_modify = option_definition.option(    #TODO: valid_ranges for GUI!!
            ...
            tokens=[option_definition.addLogical(name='id1', logicals=['gg', 'ssa', 'tau', 'tau550'],setting='MODIFY_VAR_',gui_name='variable'),
        ...
        aerosol_haze = option_definition.option(
            ...
            # gui_inputs=(GUI_definition.IntegerListInput(name='Input.aer.haze', default=None, valid_range=[1, 4, 5, 6]),),
        ...
        aerosol_set_tau_at_wvl = option_definition.option(
            ...
            tokens=[option_definition.addToken(name='Input.aer.tau_wvl_lambda', datatype=float, default='NOT_DEFINED_FLOAT', valid_range=[0,1e6]),
                    option_definition.addToken(name='Input.aer.tau_wvl_tau', datatype=float, default='NOT_DEFINED_FLOAT', valid_range=[0,1e6]),
                    option_definition.addSetting(name='Input.aer.modify[MODIFY_VAR_TAU550][MODIFY_TYPE_SET]', setting='Input.aer.tau_wvl_tau' ),
                    option_definition.addSetting(name='Input.aer.spec', setting=1, default=0)],
        )
        ...
        aerosol_species_file = option_definition.option(  #TODO: undefined number of optional arguments are allowed
            ...
            gui_inputs=(GUI_definition.ListInput(name='Input.aer.mixture_name',
                       valid_range=['continental_clean', 'continental_average',
                                    'continental_polluted', 'urban', 'maritime_clean', 
                                    'maritime_polluted', 'maritime_tropical', 'desert', 
                                    'antarctic'], optional=False),),
            tokens = [option_definition.addToken(name='Input.aer.mixture_name', datatype=str,
                                valid_range = ['continental_clean', 'continental_average', 'continental_polluted', 
                                    'urban', 'maritime_clean', 'maritime_polluted', 'maritime_tropical', 'desert',
                                    'antarctic','desert_spheriods']),
                      option_definition.addSetting(name='Input.aer.n_species', setting=-1, default='NOT_DEFINED_INTEGER'),
                      option_definition.addSetting(name='Input.aer.spec', setting=1)],
        )
        ...
        aerosol_visibility = option_definition.option(
            ...
            tokens=[option_definition.addToken(name='Input.aer.visibility', datatype=float, default='NOT_DEFINED_FLOAT', valid_range=[0,1e6])],
            childs=['aerosol_option_specification'],
            extra_dependencies=['aerosol_haze','aerosol_vulcan','aerosol_visibility','aerosol_season'],
        )
        ...
        aerosol_vulcan = option_definition.option(
            ...
            # gui_inputs=(GUI_definition.IntegerListInput(name='Input.aer.vulcan', default=None, valid_range=[1, 2, 3, 4], optional=False),),
        ...
        self.options = [aerosol_default,
            ...
            aerosol_sizedist_file, aerosol_refrac_index]

    def __iter__(self):
        return iter(self.options)

def get_documentation():
    return get_aerosol_documentation()
