...
class setup_mc_group():
    ...
    def __init__(self):
        ...
        mc_core = option_definition.option(
            name='mc_core',
            group='mc',
            ...
            tokens= [option_definition.addSetting(name="Input.rte.mc.core_isactive", setting=1),
                     option_definition.addSetting(name='isp', setting='get_caoth_index(&Input.caoth,&Input.n_caoth,"hiddencore_dummy",0)'),
                     option_definition.addSetting(name='iwc', setting='get_caoth_index(&Input.caoth,&Input.n_caoth,"wc",0)'),
                     option_definition.addSetting(name='Input.caoth[isp].source', setting='CAOTH_FROM_3D'),
                     option_definition.addSetting(name='Input.caoth[isp].filename', setting='Input.caoth[iwc].filename'),
                     option_definition.addSetting(name='Input.caoth[isp].properties', setting='PROP_HU'),
                     option_definition.addToken(name='Input.rte.mc.core_inputfile', datatype=str, optional=True, default="NULL"),
                ],
            parents=['uvspec'],
            speaker='rte_solver',
            enable_values=("mystic","montecarlo"),
        ...
        mc_core_threshold = option_definition.option(
            name='mc_core_threshold',
            group='mc',
            documentation=documentation['mc_core_threshold'],
            tokens=[option_definition.addToken(name='Input.rte.mc.core_threshold', datatype=float,valid_range=[0,10000],default=3)],
            developer=True,
        )

        mc_core_scale = option_definition.option(
            name='mc_core_scale',
            group='mc',
            documentation=documentation['mc_core_scale'],
            tokens=[option_definition.addToken(name='Input.rte.mc.core_scale', datatype=float,valid_range=[-100000,0.9999999999],default=-1)],
            developer=True,
        )

        mc_core_savefile = option_definition.option(
            name='mc_core_savefile',
            group='mc',
            documentation=documentation['mc_core_savefile'],
            tokens=[option_definition.addToken(name='Input.rte.mc.core_savefile', datatype=str, optional=True, default="NULL")],
            developer=True,
        )
        ...
        mc_backward = option_definition.option(
            ...
            tokens=[option_definition.addSetting(name="Input.rte.mc.backward.yes", setting=1),
                    option_definition.addToken(name="Input.rte.mc.backward.islower", datatype=int, optional=True, default='NOT_DEFINED_INTEGER'),
                    option_definition.addToken(name="Input.rte.mc.backward.jslower", datatype=int, optional=True, default='NOT_DEFINED_INTEGER'),
                    option_definition.addToken(name="Input.rte.mc.backward.isupper", datatype=int, optional=True, default='NOT_DEFINED_INTEGER'),
                    option_definition.addToken(name="Input.rte.mc.backward.jsupper", datatype=int, optional=True, default='NOT_DEFINED_INTEGER')],
            parents=['uvspec'],
        ...
        mc_spectral_is = option_definition.option(
            ...
            tokens=[option_definition.addSetting(name='Input.rte.mc.spectral_is', setting=True, default=False),
                    option_definition.addToken(name='Input.rte.mc.spectral_is_wvl[0]', datatype=float, valid_range=[0, 1e6],optional=True)],
            parents=['uvspec'],
            speaker='rte_solver',
            enable_values=("mystic","montecarlo"),
            mystic=True,
        ...
        mc_boxairmass = option_definition.option(
            ...
            tokens=[option_definition.addLogical(name='id', logicals=['1D','3D'],setting='DIM_'),
                    option_definition.addSetting(name='Input.rte.mc.boxairmass[id]', setting=1)],
            parents=['mc_backward'],
            speaker='rte_solver',
            enable_values=("mystic","montecarlo"),
            mystic=True,
        ...
        mc_backward_heat = option_definition.option(
            ...
            tokens=option_definition.addLogical(name='Input.rte.mc.backward.thermal_heating_method',
                        logicals=['HYBRID','EMABS','EMABSOPT','DENET'],
            setting='MCBACKWARD_HEAT_',
        ...
        mc_coherent_backscatter = option_definition.option(
            ...
            tokens=[option_definition.addSetting(name='Input.rte.mc.coherent_backscatter',setting=1,default=0),
                    option_definition.addToken(name='Input.rte.mc.coherent_backscatter_lmode',datatype=int, optional=True,default=1),
                    option_definition.addToken(name='Input.rte.mc.coherent_backscatter_off',datatype=int, optional=True,default=0)],
            parents=[],
            speaker='rte_solver',
            enable_values=("mystic","montecarlo"),
            mystic=True,
        ...
        mc_polarisation = option_definition.option(
            ...
            tokens=[option_definition.addSetting(name='Input.rte.mc.polarisation', setting=1, default=0),
                    ...
                    option_definition.addToken(name='Input.rte.mc.polarisation_state', datatype=int,
                          valid_range=[-3,4],default=0,optional=True)],
            parents=['uvspec'],
            speaker='rte_solver',
            enable_values=("mystic","montecarlo"),
            mystic=True
