"""--------------------------------------------------------------------
 * $Id: molecular_options.py 3145 2015-08-04 13:35:30Z josef.gasteiger $
 * 
...
class setup_molecular_group():
	...
	def __init__(self):
		...
		crs_model = option_definition.option(
			...
			gui_inputs=(GUI_definition.ListInput(name='mol_id', valid_range=['no2', 'o3', 'rayleigh'], optional=False), GUI_definition.ListInput(name='crs_model', valid_range=['Bass_and_Paur', 'Molina', 'Daumont', 'Bogumil', 'Bodhaine', 'Bodhaine29', 'Nicolet', 'Penndorf', 'Burrows'], optional=False),),
			tokens= [ option_definition.addLogical( name='mol_id', logicals=['no2', 'o3', 'rayleigh'], setting='CRS_MOL_' ),
				option_definition.addLogical( name='Input.crs_model[mol_id]',  logicals=[ 'Bodhaine', 'Nicolet', 'Penndorf', 'Bodhaine29', 'Bass_and_Paur', 'Molina', 'Daumont', 'Bogumil', 'Burrows'], setting='CRS_MODEL_') ],
			parents=['uvspec'],
			non_unique=True,
		)
		...
		mol_abs_param = option_definition.option(
			...
			tokens = [ option_definition.addLogical( name='Input.ck_scheme', logicals=['kato', 'kato2', 'kato2.96','fu','avhrr_kratz','sbdart','lowtran','reptran','reptran_channel','crs',io.IOBase], setting='CK_'),
		...
		self.options = [atmosphere_file, radiosonde, radiosonde_levels_only,
